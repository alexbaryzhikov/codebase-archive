 ...
 * lookup. Considering high cost of looking up JNDI for a service, Service Locator pattern makes
 * use of caching technique. For the first time a service is required, Service Locator looks up in
 * JNDI and caches the service object. Further lookup or same service via Service Locator is done
 * in its cache which improves the performance of application to great extent. Following are the
